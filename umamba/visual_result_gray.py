...
def visualize_batch_labels_gray(
    ...
    pred_label_paths = list(Path(pred_label_dir).glob("*.tif"))
...
if __name__ == "__main__":
    # 已推理出的标签图文件夹（必填）
    PRED_LABEL_DIR = r"../data/nnUNet_results/Dataset005_dx1024/nnUNetTrainerUMambaBot__nnUNetPlans__2d/fold_0/validation"
    # 灰度可视化结果保存文件夹（自动创建）
    SAVE_VISUAL_DIR = r"../data/nnUNet_results/Dataset005_dx1024/nnUNetTrainerUMambaBot__nnUNetPlans__2d/fold_0/mask_visual"
